...
packages_to_install <- c(
  ...
  "harmony", "remotes", "SeuratDisk","SeuratDisk","BioManager"
)
...
sobj_ys_filtered_integrated <- sobj_ys_filtered %>%
  RunHarmony(group.by.vars = 'fetal.ids', plot_convergence = FALSE)
...
#p7 <- DimPlot(sobj_ys_harmony, reduction = 'umap', group.by = 'stage')
...
FeaturePlot(sobj_ys_harmony features = c('RUNX1','CD34','GATA2','GATA1','MITF','BATF','KIT','IL3'))
